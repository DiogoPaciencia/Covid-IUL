 ...
 ** Descrição/Explicação do Módulo: Este programa pede o nome e o número de utente de um cidadão, e envia estes dados para o servidor. O servidodor irá verificar se o cidadão existe na base de dados e vai enviar uma resposta ao cidadao,
 **									que irá agir de acordo com esta resposta, terminando a sessão ou pedindo ao servidor para efetuar a vacinação, caso seja possível.
 **
 ******************************************************************************/
#include "common.h"
#include "utils.h"
...
void cria_mensagem() {
	...
	printf("Qual é o seu número de utente? ");
    scanf("%u", &mensagem.dados.num_utente);
